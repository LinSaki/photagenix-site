...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-border-n-6 lg:bg-n-8/90 lg:backdrop-blue-sm-">
          ...
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              <a
                ...
                } px-6 py-8 md:py-8 lg:-mr-0.25 lg:text-base lg:font-semibold ${
